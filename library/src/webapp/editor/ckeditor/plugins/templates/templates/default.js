...
CKEDITOR.addTemplates('default', {imagesPath: CKEDITOR.getUrl(CKEDITOR.plugins.getPath('templates') + 'templates/images/'), templates: [
    ...
    },
    {
        ...
        html: '<div align="left" style="width: 30em; float: left; margin: 0 10px 20px 0;"> <div style="float: left;"> <img style="width: 100px; height: 100px;" /></div> <div stlye="float: left; margin-right: 5px;"> <h3> First title</h3> <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> </div> </div> <div align="left" style="width: 30em; float: left; margin: 0 10px 20px 0; clear: right;"> <div style="float: left; margin-right: 5px;"> <img style="width: 100px; height: 100px;" /></div> <div stlye="float: left; margin-right: 5px;"> <h3> Second title</h3> <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> </div> </div> <div align="left" style="width: 30em; float: left; margin: 0 10px 20px 0; clear: left;"> <div style="float: left; margin-right: 5px;"> <img style="width: 100px; height: 100px;" /></div> <div stlye="float: left;"> <h3> Third title</h3> <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> </div> </div> <div align="left" style="width: 30em; float: left; margin: 0 10px 20px 0; clear: right;"> <div style="float: left;"> <img style="width: 100px; height: 100px;" /></div> <div stlye="float: left;"> <h3> Fourth title</h3> <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> </div> </div> <div style="clear: both;"> &nbsp;</div>'
    }
]});
